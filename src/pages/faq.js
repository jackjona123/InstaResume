...
const FrequentlyAskedQuestions = () => (
  <Wrapper>
    <Helmet>
      <title>Frequently Asked Questions | InstaResume</title>
      <link
        rel="canonical"
        href="https://instaresume.jackjona.live/app/dashboard"
      />
    </Helmet>
    ...
    <div className="md:w-1/2 container px-8 md:px-0 py-16 grid gap-12">
      ...
      <div>
        <h4 className="text-xl font-medium mb-4">
          ...
          the first version of InstaResume?
        </h4>
        <p className="leading-loose">
      ...
      <div>
        <h4 className="text-xl font-medium mb-4">
          Is there a mobile app for InstaResume?
        </h4>
        <p className="leading-loose">

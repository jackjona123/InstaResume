    ...
    <Wrapper>
      ...
      <div className="container px-8 xl:px-0 text-center md:text-left mt-24">
        ...
        <p className="leading-loose text-lg mt-16">
          InstaResume is a free and open source resume builder that’s built to
        ...
        <div className="pt-8 grid lg:grid-cols-2 lg:gap-x-10">
          ...
          >
            ...
            difficult to update your own resume, but InstaResume makes it as
            easy as few clicks.
          </Feature>
        ...
        <div className="my-24">
          ...
          <div className="grid grid-cols-3 md:grid-cols-4 gap-8">
            ...
            <a
              href="https://www.producthunt.com/posts/insta-resume"
              rel="noreferrer"
              target="_blank"
            >
        ...
        <footer className="my-24">
          <p className="text-primary-500">
            Licensed under <a href="/">GPL</a>
            <br />
            &copy; 2021 <a href="https://www.jackjona.live/">Jack Jona</a> |
            Made With ❤️
          </p>
        </footer>
      </div>
